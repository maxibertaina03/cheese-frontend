...
export const Header: React.FC<HeaderProps> = ({
  ...
  const { isAdmin, canAccess } = usePermissions(user);
    ...
    <div className="header">
      <div className="header-content">
        ...
        <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
          {onOpenElementos && canAccess('elementos') && (
            <button
          ...
          {onOpenIndumentaria && canAccess('indumentaria') && (
            <button
              className="btn-primary"
              onClick={onOpenIndumentaria}
          ...
          {onOpenDashboard && canAccess('dashboard') && (
            <button
              className="btn-primary"
